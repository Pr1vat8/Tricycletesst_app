...
public class PayoutRepository {
    ...
    private static void createDefaultData(Context context) {
        payoutList.clear();
        payoutList.add(new Payout("Ethan Carter", "150", "Pending"));
        payoutList.add(new Payout("Olivia Bennett", "200", "Pending"));
        payoutList.add(new Payout("Noah Thompson", "180", "Pending"));
        payoutList.add(new Payout("Ava Martinez", "220", "Pending"));
        payoutList.add(new Payout("Liam Harris", "170", "Pending"));
        payoutList.add(new Payout("Sophia Wilson", "300", "Paid")); // History example
    ...
    public static void loadAll(Context context) {
        ...
        try (FileInputStream fis = context.openFileInput(FILE_NAME);
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length >= 3) {
                    payoutList.add(new Payout(parts[0].trim(), parts[1].trim(), parts[2].trim()));
                }
            }
